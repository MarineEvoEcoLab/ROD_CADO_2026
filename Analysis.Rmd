...
# fail loudly rather than silently dropping a column downstream
stopifnot(all(c("CHROM","BIN_START","BIN_END","PI","Treatment")      %in% names(pi.focal)),
          all(c("CHROM","BIN_START","BIN_END","TAJD","Treatment")    %in% names(tajd.focal)),
          all(c("CHROM","BIN_START","BIN_END","OBS_HET","Treatment") %in% names(het.focal)))
```
